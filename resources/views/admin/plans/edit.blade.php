<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">แก้ไขแผนงาน</h2>
    </x-slot>

    <div class="py-8 max-w-2xl mx-auto sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('admin.plans.update', $plan) }}" class="bg-white shadow-sm rounded-lg p-6 space-y-4">
            @csrf
            @method('PUT')
