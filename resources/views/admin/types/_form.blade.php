...
<div>
    <label class="block text-sm font-medium mb-1 text-gray-500">ชื่อประเภท (English)</label>
    <input type="text" name="name_en" value="{{ old('name_en', $type?->name_en) }}" class="w-full border-gray-300 rounded-md">
...
<div>
    ...
    <textarea name="description_en" rows="3" class="w-full border-gray-300 rounded-md">{{ old('description_en', $type?->description_en) }}</textarea>
